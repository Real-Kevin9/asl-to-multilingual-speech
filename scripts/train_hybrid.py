...
from modules.recognition.hybrid_trainer import HybridTrainer


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train the hybrid MobileNetV2 + BiLSTM + landmark-geometry recogniser"
    )
    parser.add_argument("--cache-dir", default="data/processed/hand_crops_v2")
    ...
    trainer = HybridTrainer(output_dir=args.output_dir)
